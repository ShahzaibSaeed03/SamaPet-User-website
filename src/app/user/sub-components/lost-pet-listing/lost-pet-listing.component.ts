...
@Component({
  selector: 'app-lost-pet-listing',
  standalone: true,
  imports: [NavbarComponent],
  templateUrl: './lost-pet-listing.component.html',
  styleUrls: ['./lost-pet-listing.component.css']
})
export class LostPetListingComponent implements OnInit {
